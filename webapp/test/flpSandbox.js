		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#sapprj2projecthelloworld2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapprj2projecthelloworld2-display": {
								"semanticObject": "sapprj2projecthelloworld2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.prj2.projecthelloworld2",
									"url": sap.ui.require.toUrl("sap/prj2/projecthelloworld2")
								}
							}
						}
					}
